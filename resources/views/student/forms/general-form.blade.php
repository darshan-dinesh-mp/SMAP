    ...
    <div class="flex items-center justify-center flex-col">
        <form class="px-4 lg:px-12 space-y-8 py-8 bg-secondary w-3/4" action="{{ route('submit-form') }}" method="post">
            ...
            <div>
                ...
                <div class="flex flex-col text-xl space-y-4 mb-4">
                    <div>
                        ...
                        <input type="text" name="field1" class="input border-b-2 outline-none w-2/4 border-primary py-2"
                            placeholder="type your text here. ">
                    </div>
                    <div>
                        <p class="font-medium">Action taken</p>
                        <input type="text" name="field2" class="input border-b-2 outline-none w-2/4 border-primary py-2"
                            placeholder="type your text here. ">
                    </div>
                    <div>
                ...
                <div class="flex flex-col text-xl space-y-4 mb-4">
                    <div>
                        ...
                        <input type="text" name="field4" class="input border-b-2 outline-none w-2/4 border-primary py-2"
                            placeholder="type your text here. ">
                    </div>
                    <div>
                        <p class="font-medium">Action taken</p>
                        <input type="text" name="field5" class="input border-b-2 outline-none w-2/4 border-primary py-2"
                            placeholder="type your text here. ">
                    </div>
                    <div>
                        <p class="font-medium">State of the issue</p>
            ...
            <div>
                ...
                <div class="flex flex-col text-xl space-y-4 mb-4">
                    <div>
                        ...
                        <input type="text" name="field7" class="input border-b-2 outline-none w-2/4 border-primary py-2"
                            placeholder="type your text here. ">
                    </div>
                    <div>
                        <p class="font-medium">Action taken</p>
                        <input type="text" name="field8" class="input border-b-2 outline-none w-2/4 border-primary py-2"
                            placeholder="type your text here. ">
                    </div>
                    <div>
                        <p class="font-medium">State of the issue</p>
                ...
                <div class="flex flex-col text-xl space-y-4 mb-4">
                    <div>
                        ...
                        <input type="text" name="field10" class="input border-b-2 outline-none w-2/4 border-primary py-2"
                            placeholder="type your text here. ">
                    </div>
                    <div>
                        <p class="font-medium">Action taken</p>
                        <input type="text" name="field11" class="input border-b-2 outline-none w-2/4 border-primary py-2"
                            placeholder="type your text here. ">
                    </div>
                    <div>
                        <p class="font-medium">State of the issue</p>
            ...
            <div>
                ...
                <div class="space-y-4">
                    <input type="text" name="field13" class="input border-b-2 outline-none w-2/4 border-primary py-2"
                        placeholder="project one">

                    <input type="text" name="field14" class="input border-b-2 outline-none w-2/4 border-primary py-2"
